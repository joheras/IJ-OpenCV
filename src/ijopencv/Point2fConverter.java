 ...
 * @author jonathan
 */
public class Point2fConverter implements IConverter<PointRoi, opencv_core.Point2f>{

    @Override
    public opencv_core.Point2f convertTo(PointRoi pr) {
        if (!canConvertTo(pr)) {
            try {
    ...
    @Override
    public PointRoi convertFrom(opencv_core.Point2f p) {
        if (!canConvertFrom(p)) {
            try {
    ...
    @Override
    public boolean canConvertFrom(opencv_core.Point2f p) {
        if (p.sizeof() != 2) {
            return false;
        }
        return true;
